...
class CreateEmployeeController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate
{
    ...
    let firstNameTextField = UITextField(placeholder: "Enter First Name", text: "temp")
    let lastNameTextField = UITextField(placeholder: "Enter Last Name", text: "temp")
    let socialidTextField = UITextField(placeholder: "Enter Socialid NO", text: "")
    let phoneTextField = UITextField(placeholder: "Phone", text: "temp")
    let hiringDateField = UITextField(placeholder: "MM/dd/yyyy", text: "11/11/11")
    let cityField = UITextField(placeholder: "Enter City", text: "temp")
    let houseNoField = UITextField(placeholder: "Enter HouseNo", text: "1")
    let streetField = UITextField(placeholder: "Enter Street", text: "temp")
