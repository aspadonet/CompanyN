...
class EmployeeInOfficeViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.leftBarButtonItems = [
            UIBarButtonItem(title: "Delet All", style: .plain, target: self, action: #selector(handleReset))
        ]
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        tableView.register(EmployeeInOfficeCell.self, forCellReuseIdentifier: reuseIdentifier)
        tableView.register(EmployeeHeaderView.self, forHeaderFooterViewReuseIdentifier: headerReuseIdentifier)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: reuseIdentifier, for: indexPath) as! EmployeeInOfficeCell
